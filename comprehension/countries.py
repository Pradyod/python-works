...
def all_countries_name(countries):
    all_c_name=[c.get("name") for c in countries if c.get("name")]
    return all_c_name
# print(all_countries_name(countries))

def get_country_by_name(country_name):
    return [c for c in countries if c.get("name").lower()== country_name]
# print(get_country_by_name("india"))

def get_country_name_cap(country_name):
    return [c.get("name").upper() for c in countries if c.get("name").lower()==country_name]
# print(get_country_name_cap("india"))
####
def get_region_by_name(country_name):
    return [c.get("region") for c in countries if c.get("name").lower()==country_name]
# print(get_region_by_name("india"))

def independent_countries(countries):
    return [c.get("name") for c in countries if c.get("independent")== True]
# print(independent_countries(countries))

def non_independent_countries(countries):
    return [c.get("name") for c in countries if c.get("independent")== False]
# print(non_independent_countries(countries))

def border(country_name):
    return [c.get("borders") for c in countries if c.get("name").lower()==country_name]
# print(border("india"))

def native_name(country_name):
    return [c.get("nativeName") for c in countries if c.get("name").lower()==country_name]
# print(native_name("india"))

def population(country_name):
    return [c.get("population") for c in countries if c.get("name").lower()==country_name]
# print(population("india"))

def get_country_by_region(region_name):
    return [c.get("name") for c in countries if c.get("region").lower()==region_name]
# print(get_country_by_region("asia"))

def currency(country_name):
    return [c.get("currencies") for c in countries if c.get("name").lower()==country_name]
# print(currency("india"))

def language(country_name):
    return [c.get("languages") for c in countries if c.get("name").lower()==country_name]
print(language("india"))

def max_population(countries):
    max_pop=0
    for c in countries:
        ...
        if pop > max_pop:
            max_pop = pop
    return max_pop
# print(max_population(countries))

# def currency_by_symbol():

def most_border(countries):
    border={c.get("name"):c.get("borders") for c in countries}
print(most_border(countries))
